...
class ParkingLot:
    ...
    def __init__(self, capacity):
        ...
        if ParkingLot.__instance != None:
            raise MultipleSingletonInstantiationException(
                "class instance already created")
        else:
    ...
    def park_vehicle(self, vehicle_type, registration_number, driver_age):
        return self.__slotManager.park_vehicle(vehicle_type, registration_number, driver_age)
    ...
    def get_registration_numbers_for_cars_with_driver_age(self, driver_age):
        return self.__slotManager.registration_numbers_for_cars_with_driver_age(driver_age)

    def get_slot_numbers_for_cars_with_driver_age(self, driver_age):
        return self.__slotManager.slot_numbers_for_cars_with_driver_age(driver_age)
